...
/* eslint-disable */ var _esnextArrayLastIndexJs = require("core-js/modules/esnext.array.last-index.js");
...
},{"55dbb5f28b3adadd":"dIGt4","e22ea4363ad9593":"2lsJ0"}],"2lsJ0":[function(require,module,exports,__globalThis) {
'use strict';
...
},{"b242f76140e5af2":"kL2X6"}],"kL2X6":[function(require,module,exports,__globalThis) {
'use strict';
var $TypeError = TypeError;
module.exports = function(argument) {
...
},{"e59600cb85bb62cf":"a6ntP"}],"a6ntP":[function(require,module,exports,__globalThis) {
'use strict';
...
},{"add364a3528fced5":"9fY7y","37803d7d6a462653":"en5fF","85c8c6cafea43f5e":"iJR4w","fd14df1ab8806f1a":"lk5NI"}],"en5fF":[function(require,module,exports,__globalThis) {
'use strict';
...
/* eslint-disable */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "bookTour", ()=>bookTour) // import axios from 'axios';
...
;
var _alerts = require("./alerts");
async function bookTour(bookBtn) {
    ...
    try {
        ...
        console.log(data);
        if (data.session && data.session.url) window.location.href = data.session.url;
        else {
            bookBtn.textContent = 'Book tour now!';
            (0, _alerts.showAlert)('error', 'Error by creating Stripe Checkout.');
        }
    } catch (err) {
        bookBtn.textContent = 'Book tour now!';
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./alerts":"6Mcnf"}]},["9lKfK","f2QDv"], "f2QDv", "parcelRequire11c7", {})
